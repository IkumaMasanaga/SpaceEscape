...
static int mouse_now_input = 0;
static int mouse_prev_input = 0;
static unsigned char mouses[Input::MOUSE_MAX] = {
...
void Input::update() {
	...
	mouse_prev_input = mouse_now_input;
	mouse_now_input = GetMouseInput();
}
...
bool Input::isMouseDown(eMouses mouse) {
	return (mouse_now_input & mouses[mouse]);
}

bool Input::isMouseDownTrigger(eMouses mouse) {
	return (mouse_now_input & mouses[mouse]) && (mouse_now_input & mouses[mouse]) != (mouse_prev_input & mouses[mouse]);
}

bool Input::isMouseReleaseTrigger(eMouses mouse) {
	return (mouse_prev_input & mouses[mouse]) && (mouse_now_input & mouses[mouse]) != (mouse_prev_input & mouses[mouse]);
}
