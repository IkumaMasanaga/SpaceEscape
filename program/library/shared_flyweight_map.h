...
namespace t2k {
	...
	class SharedFlyweightMapInterface {
	protected:
	...
	protected:
		inline static SharedFlyweightMap flyweight_map_;

		// 終了処理
		virtual void finalize() = 0;

	public:
		SharedFlyweightMapInterface() {}
		virtual ~SharedFlyweightMapInterface() {}

		// 参照されなくなったリソースの開放
		inline static void releaseUnique() { flyweight_map_.eraseUnique(); }
	};
